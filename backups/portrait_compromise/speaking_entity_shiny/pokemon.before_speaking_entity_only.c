...
{
    /*
     * Preserve vanilla dialogue sprite availability when vanilla portraits exist.
     * Only report generated availability for species that have no vanilla portrait.
     */
    if (sMonsterParameters[index].dialogueSprites != 0)
